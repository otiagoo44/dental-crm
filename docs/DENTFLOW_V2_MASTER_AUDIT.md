...
| DF-004 | MEDIUM | Work | Pending/Followups/Tasks overlap | routing, nextActions and server projection | Canonical `/trabajo` projection; legacy routes retained for parity/debug | PASS local + staging query; browser staging pending |
