...
### Community 0 - "App"
Cohesion: 0.06
Nodes (53): App(), completeTask(), confirmAppointmentById(), createLeadEvent(), createManualLead(), handleLeadSelect(), handleMessageCopied(), handleWhatsAppOpened() (+45 more)

### Community 1 - "analytics.js"
Cohesion: 0.06
Nodes (53): MetricsView, appointmentMoment(), ATTENDED_EVENTS, beforeEnd(), BOOKING_EVENTS, buildAnalytics(), buildBottleneck(), buildCohortStages() (+45 more)

### Community 2 - "scripts"
Cohesion: 0.04
Nodes (46): dependencies, lucide-react, motion, react, react-dom, @supabase/supabase-js, vite, @vitejs/plugin-react (+38 more)
...
Cohesion: 0.10
Nodes (26): PasswordInput(), useClinicWorkspace(), bootstrapUser(), loadPublicFormConfig(), useSupabaseSession(), EXPIRED_PASSWORD_RECOVERY_MESSAGE, INVALID_PASSWORD_RECOVERY_MESSAGE, readPasswordRecoveryRedirect() (+18 more)
...
Cohesion: 0.10
Nodes (27): AgendaView, ArchiveLeadModal, ContactOutcomeModal, PublicEmbedLeadForm, QuoteModal, TaskFormModal, Banner(), FullScreenLoader() (+19 more)

### Community 11 - "LeadsPage.jsx"
Cohesion: 0.10
Nodes (23): LeadDetail, LeadsView, PendingView, LeadMiniCard(), formatActionMoment(), PendingActionCard(), ActiveFilterChips(), FilterSheet() (+15 more)

### Community 12 - "AgendaPage.jsx"
Cohesion: 0.15
Nodes (21): AppointmentModal, AppointmentModal(), handleSubmit(), buildTimeSlots(), getAppointmentFormDefaults(), StatCard(), StatusBadge(), statusStyles (+13 more)

### Community 13 - "LeadFormModal.jsx"
Cohesion: 0.14
Nodes (22): LeadFormModal, ContactOutcomeModal(), selectedFollowupAt(), submit(), followupPresetValue(), getLeadFormDefaults(), LeadFormModal(), defaults() (+14 more)
...
Cohesion: 0.14
Nodes (16): Dashboard, FollowupsView, TasksView, Card(), EmptyState(), FilterPanel(), PageHeader(), PriorityBadge() (+8 more)

### Community 17 - "visual-harness/main.jsx"
Cohesion: 0.09
Nodes (19): AppLayout(), icons, NAV_ITEMS, Dashboard(), actionLabel(), actionTypeOptions(), PendingPage(), appointments (+11 more)
...
### Community 19 - "QuoteModal.jsx"
Cohesion: 0.28
Nodes (10): Field(), Select(), TextArea(), ModalActions(), ModalHeader(), Button(), variants, ModalShell() (+2 more)
...
### Community 21 - "normalizeText"
Cohesion: 0.17
Nodes (19): WhatsAppButton(), normalizeTaskStatus(), normalizeText(), buildLeadMessage(), buildMessageFromTemplate(), buildWhatsAppMessage(), buildWhatsappUrl(), getWhatsAppTemplate() (+11 more)
...
Cohesion: 0.27
Nodes (15): isOpenTask(), isTerminalLeadStatus(), normalizeLeadStatus(), actionCandidate(), appointmentDateTime(), chooseCandidate(), compareCandidates(), getEffectiveNextAction() (+7 more)
...
Cohesion: 0.20
Nodes (8): SettingsView, Info(), publicFormFetchSnippet(), publicFormPayloadExample(), WHATSAPP_TEMPLATE_DEFINITIONS, WHATSAPP_VARIABLES, roleLabel(), TeamSettings()
...
### Community 35 - "commercialInsights.js"
Cohesion: 0.22
Nodes (8): EVENT_COPY, getLeadPriority(), getRiskAlerts(), LOST_REASONS, PRIORITY_FILTERS, buildNextActionQueue(), compareQueueItems(), PRIORITY_GROUP
...
### Community 39 - "retention-insights-test.mjs"
Cohesion: 0.22
Nodes (8): alerts, controlled, hotLead, now, rendered, report, timeline, urgent
...
- **Why does `humanizeCrmError()` connect `App` to `SettingsPage.jsx`, `analytics.js`, `useClinicWorkspace.js`, `staging-workflow.mjs`, `App.jsx`, `AgendaPage.jsx`, `LeadFormModal.jsx`, `QuoteModal.jsx`, `normalizeText`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `@supabase/supabase-js` connect `staging-qa-setup.mjs` to `scripts`, `useClinicWorkspace.js`, `staging-workflow.mjs`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `react` connect `QuoteModal.jsx` to `SettingsPage.jsx`, `analytics.js`, `scripts`, `useClinicWorkspace.js`, `App.jsx`, `LeadsPage.jsx`, `AgendaPage.jsx`, `GlobalErrorBoundary`, `LeadFormModal.jsx`, `FollowupsPage.jsx`, `visual-harness/main.jsx`?**
