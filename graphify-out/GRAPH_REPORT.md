...
6. `scripts` - 22 edges
7. `todayIsoDate()` - 20 edges
8. `getEffectiveNextAction()` - 19 edges
9. `cleanOptionalText()` - 17 edges
10. `normalizeText()` - 17 edges
...
- `handleSave()` --calls--> `humanizeCrmError()`  [EXTRACTED]
  crm-app/src/pages/SettingsPage.jsx → crm-app/src/lib/errors.js
- `App()` --calls--> `useClinicWorkspace()`  [EXTRACTED]
  crm-app/src/App.jsx → crm-app/src/hooks/useClinicWorkspace.js
- `App()` --calls--> `useSupabaseSession()`  [EXTRACTED]
  crm-app/src/App.jsx → crm-app/src/hooks/useSupabaseSession.js

## Import Cycles
- None detected.

## Communities (158 total, 63 thin omitted)

### Community 0 - "App"
Cohesion: 0.06
Nodes (54): App(), completeTask(), confirmAppointmentById(), createLeadEvent(), createManualLead(), handleLeadSelect(), handleMessageCopied(), handleWhatsAppOpened() (+46 more)

### Community 1 - "analytics.js"
Cohesion: 0.17
Nodes (28): appointmentMoment(), ATTENDED_EVENTS, BOOKING_EVENTS, buildAnalytics(), buildBottleneck(), buildFunnel(), buildLossRows(), buildPeriodCore() (+20 more)

### Community 2 - "scripts"
Cohesion: 0.09
Nodes (22): scripts, build, build:production, build:staging, dev, preview, test, test:appointment (+14 more)
...
### Community 6 - "useClinicWorkspace.js"
Cohesion: 0.10
Nodes (25): PasswordInput(), useClinicWorkspace(), bootstrapUser(), loadPublicFormConfig(), useSupabaseSession(), EXPIRED_PASSWORD_RECOVERY_MESSAGE, INVALID_PASSWORD_RECOVERY_MESSAGE, readPasswordRecoveryRedirect() (+17 more)

### Community 7 - "staging-workflow.mjs"
Cohesion: 0.07
Nodes (37): defaults(), QuoteModal(), submit(), updateTreatment(), findTreatmentPrice(), normalizeTreatmentKey(), quoteTreatmentOptions(), options (+29 more)
...
Cohesion: 0.06
Nodes (46): AppointmentModal, ArchiveLeadModal, ContactOutcomeModal, Dashboard, FollowupsView, LeadDetail, LeadFormModal, LeadsView (+38 more)

### Community 11 - "LeadsPage.jsx"
Cohesion: 0.15
Nodes (17): LeadMiniCard(), buildCommercialTimeline(), EVENT_COPY, getLeadPriority(), LOST_REASONS, PRIORITY_FILTERS, displayConsultationReason(), isArchivedLead() (+9 more)

### Community 12 - "AppointmentModal.jsx"
Cohesion: 0.35
Nodes (12): AppointmentModal(), buildTimeSlots(), getAppointmentFormDefaults(), isToday(), startOfAsuncionDate(), uniqueStrings(), normalizeText(), todayIsoDate() (+4 more)
...
### Community 14 - "20260612142000_edge_function_support_indexes.sql"
Cohesion: 0.09
...
### Community 15 - "operational-workflow-test.mjs"
Cohesion: 0.07
Nodes (27): normalizeTaskStatus(), baseLead, coldOverdueBeforeHotTomorrow, confirmationAction, duplicateLeadRows, earliestOpenTask, futureAction, futureAfterDue (+19 more)

### Community 16 - "FollowupsPage.jsx"
Cohesion: 0.16
Nodes (18): PendingView, formatActionMoment(), PendingActionCard(), WhatsAppButton(), Card(), EmptyState(), FilterPanel(), ActiveFilterChips() (+10 more)

### Community 17 - "visual-harness/main.jsx"
Cohesion: 0.05
Nodes (32): MetricsView, AppLayout(), icons, formatDurationMinutes(), buildWeeklyReportText(), NAV_ITEMS, formatMoney(), Dashboard() (+24 more)

### Community 18 - "intake-abuse-load.mjs"
Cohesion: 0.09
Nodes (23): allowedHost, baseBody(), burstRows, burstSizes, burstText, confirmation, defaultBurstForms, endpoint (+15 more)

### Community 19 - "LeadFormModal.jsx"
Cohesion: 0.19
Nodes (17): Field(), Select(), TextArea(), followupPresetValue(), getLeadFormDefaults(), LeadFormModal(), ModalActions(), ModalHeader() (+9 more)

### Community 20 - "Dental CRM"
Cohesion: 0.09
...
### Community 21 - "retention-insights-test.mjs"
Cohesion: 0.10
...
### Community 28 - "nextActions.js"
Cohesion: 0.24
Nodes (17): isOpenTask(), isTerminalLeadStatus(), normalizeLeadStatus(), actionCandidate(), appointmentDateTime(), buildNextActionQueue(), chooseCandidate(), compareCandidates() (+9 more)

### Community 29 - "FIRST CLINIC PRODUCTION READINESS"
Cohesion: 0.13
...
### Community 32 - "SettingsPage.jsx"
Cohesion: 0.18
Nodes (12): SettingsView, Info(), formatAllowedOrigins(), generatePublicToken(), publicFormFetchSnippet(), publicFormPayloadExample(), slugify(), getPublicFormDefaults() (+4 more)

### Community 33 - "lead-intake-test.ps1"
Cohesion: 0.27
...
### Community 34 - "public.saved_views"
Cohesion: 0.24
Nodes (7): auth, public, public.saved_views, saved_views_clinic_entity_position_idx, saved_views_user_entity_name_idx, auth.users, public.clinics

### Community 35 - "staging-smoke.mjs"
Cohesion: 0.13
Nodes (15): assertCrossTenantWritesBlocked(), authenticatedClient(), client(), config, { createClient }, edgeUrl, firstId(), missing (+7 more)

### Community 36 - "Arquitectura y seguridad auditadas"
Cohesion: 0.20
...
### Community 37 - "staging-http-linked-smoke.mjs"
Cohesion: 0.22
Nodes (8): allowedOrigin, base, config, csvRow(), expectedRef, linkedRef, repoRoot, runSqlFile()

### Community 38 - "Despliegue seguro a staging"
Cohesion: 0.22
...
### Community 40 - "20260822230000_add_retention_insights.sql"
Cohesion: 0.32
...
### Community 42 - "Capacidad y escalamiento"
Cohesion: 0.25
...
### Community 43 - "Manual Acceptance Test — CRM Dental"
Cohesion: 0.25
...
### Community 46 - "Integración de landings con `lead-intake`"
Cohesion: 0.29
...
### Community 47 - "appointment-modal-flow-test.mjs"
Cohesion: 0.29
Nodes (6): abortSignalAt, appSource, clearTimeoutAt, closeModalAt, refreshAt, unlockModalAt

### Community 48 - "Pruebas no productivas de carga y seguridad"
Cohesion: 0.29
...
### Community 49 - "CRM React/Vite"
Cohesion: 0.33
Nodes (5): CRM React/Vite, Desarrollo, Supabase, Vercel, Verificacion

### Community 50 - "Auditoría de recuperación de capacidades"
Cohesion: 0.33
...
### Community 51 - "Production Release Checklist"
Cohesion: 0.33
Nodes (5): Antes, Deploy, Después, Gate obligatorio, Production Release Checklist

### Community 52 - "20260828120000_harden_public_intake_rate_limit.sql"
Cohesion: 0.47
...
### Community 53 - "Supabase backend"
Cohesion: 0.33
Nodes (5): Edge Function, Formularios multi-landing, Migraciones, Seguridad, Supabase backend

### Community 54 - "standalone-deployment-test.mjs"
Cohesion: 0.33
Nodes (5): crmRoot, envNames, packageJson, securityHeaders, vercelConfig

### Community 55 - "Reglas de desarrollo del proyecto"
Cohesion: 0.40
Nodes (4): Arquitectura, Backend y seguridad, Reglas de desarrollo del proyecto, UX y calidad

### Community 56 - "Backup y recuperación"
Cohesion: 0.40
Nodes (4): Antes del primer cliente, Backup y recuperación, Export de emergencia, Restauración

### Community 57 - "n8n Asincronico"
Cohesion: 0.40
Nodes (4): Errores Visibles, n8n Asincronico, Reglas, Tabla De Entrada

### Community 58 - "20260831190000_split_open_opportunities_by_treatment.sql"
Cohesion: 0.40
...
### Community 59 - "postgres-migration-smoke.mjs"
Cohesion: 0.40
Nodes (4): database, migrationNames, migrationsDir, projectRoot

### Community 60 - "public.save_lead_followup"
Cohesion: 0.50
Nodes (3): public.save_lead_followup(), public.leads, public.tasks

### Community 61 - "stored-xss-contract-test.mjs"
Cohesion: 0.67
...
### Community 116 - "Writing Guidelines for Postgres References"
Cohesion: 0.12
Nodes (15): 1. Concrete Transformation Patterns, 2. Error-First Structure, 3. Quantified Impact, 4. Self-Contained Examples, 5. Semantic Naming, Code Example Standards, Comments, Impact Level Guidelines (+7 more)

### Community 117 - "AgendaPage.jsx"
Cohesion: 0.16
Nodes (7): AgendaView, FilterSheet(), StatCard(), StatusBadge(), statusStyles, APPOINTMENT_ACTIVE_STATUSES, APPOINTMENT_STATUS

### Community 118 - "package.json"
Cohesion: 0.15
Nodes (12): devDependencies, autoprefixer, postcss, tailwindcss, name, private, type, version (+4 more)

### Community 119 - "Section Definitions"
Cohesion: 0.20
Nodes (9): 1. Query Performance (query), 2. Connection Management (conn), 3. Security & RLS (security), 4. Schema Design (schema), 5. Concurrency & Locking (lock), 6. Data Access Patterns (data), 7. Monitoring & Diagnostics (monitor), 8. Advanced Features (advanced) (+1 more)

### Community 120 - "owner-metrics-test.mjs"
Cohesion: 0.25
Nodes (7): buildOwnerSummary(), appointments, leads, now, quotes, summary, workspaceEvents

### Community 121 - "dependencies"
Cohesion: 0.25
Nodes (8): dependencies, lucide-react, motion, react, react-dom, @supabase/supabase-js, vite, @vitejs/plugin-react

### Community 122 - "dedupe-fix-smoke.mjs"
Cohesion: 0.25
Nodes (5): @supabase/supabase-js, anon, { createClient }, needed, require

### Community 123 - "normalizeAppointmentStatus"
Cohesion: 0.38
Nodes (7): beforeEnd(), buildCohortStages(), hasEvent(), canTransitionAppointment(), normalizeAppointmentStatus(), appointmentAt(), AppointmentCard()

### Community 124 - "Supabase Postgres Best Practices"
Cohesion: 0.33
Nodes (5): How to Use, References, Rule Categories by Priority, Supabase Postgres Best Practices, When to Apply

### Community 125 - "crm-app/vite.config.js"
Cohesion: 0.47
...
- **Why does `humanizeCrmError()` connect `App` to `SettingsPage.jsx`, `useClinicWorkspace.js`, `staging-workflow.mjs`, `App.jsx`, `AppointmentModal.jsx`, `LeadFormModal.jsx`, `retention-insights-test.mjs`, `owner-metrics-test.mjs`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `@supabase/supabase-js` connect `dedupe-fix-smoke.mjs` to `staging-smoke.mjs`, `staging-qa-setup.mjs`, `useClinicWorkspace.js`, `staging-workflow.mjs`, `package.json`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `react` connect `LeadFormModal.jsx` to `SettingsPage.jsx`, `useClinicWorkspace.js`, `App.jsx`, `LeadsPage.jsx`, `AppointmentModal.jsx`, `GlobalErrorBoundary`, `FollowupsPage.jsx`, `visual-harness/main.jsx`, `AgendaPage.jsx`, `package.json`?**
